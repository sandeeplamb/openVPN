...
variable "Public_Subnet_id" {
  ...
  type        = "map"
  default = {
    us-east-1       = "172.31.0.0/20"
    us-east-2       = "172.31.0.0/20"
    us-west-1       = "172.31.0.0/20"
    us-west-2       = "172.31.0.0/20"
    ap-northeast-1  = "172.31.0.0/20"
    ap-northeast-2  = "172.31.0.0/20"
    ap-southeast-1  = "172.31.0.0/20"
    ap-southeast-2  = "172.31.0.0/20"
    ca-central-1    = "172.31.0.0/20" 
    cn-north-1      = "172.31.0.0/20"
    eu-central-1    = "172.31.0.0/20"
    eu-west-1       = "172.31.0.0/20"
    eu-west-2       = "172.31.0.0/20"
    eu-west-3       = "172.31.0.0/20"
    sa-east-1       = "172.31.0.0/20"
    ap-northeast-3  = ""
    ap-south-1      = ""
    }
}
